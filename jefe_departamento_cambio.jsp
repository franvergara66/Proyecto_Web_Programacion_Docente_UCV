	...
	<div id="centro" style="left:105">
		...
		<div id="centro_der" name="centro_der" >
			<%
				...
				%>
			<p style="top:450; font-weight:bold;">Se realizo el cambio de estado en la Programación Docente:<br></br> de "ofertada" a "en ejecución"</p>
				<%
				else
				%>
			<p style="top:450; font-weight:bold;">Se realizo el cambio de estado en la Programación Docente:<br></br> de "en ejecución" a "ejecutada"</p>
				<%
