...
<center>
	...
	<div id="centro" style="left:105">
		...
		<div id="centro_der" name="centro_der" >
			...
			<form id="buscador1" name="buscador1" action="generaReporte" onsubmit="return procesarDatos1(this);">
			...
			<form id="buscador2" name="buscador2" action="generaReporte" onsubmit="return procesarDatos2(this);">
