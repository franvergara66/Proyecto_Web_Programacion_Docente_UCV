...
public class ProcesadorFechas extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
			...
			System.out.println(session.getAttribute("licenciatura"));
			...
			/*String materias_lic=*/ ClienteBD.obtenerMaterias(licenciatura);
			...
			Date fecha=new Date();
			String info=fecha+" "+login+" entro en Crear Partida Docente";
			...
			//ClienteBD.guardarPartidaDocente(licenciatura, filas);
			//System.out.println();
