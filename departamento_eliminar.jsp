...
<center>
	...
	<div id="centro" style="left:105">
		...
		<div id="centro_der" name="centro_der" >
			<form id="buscador" name="buscador" action="buscarPDEliminar" onsubmit="return procesarDatos(this);">
				...
				<input type="submit" id="busca" name="busca" value="Eliminar PD" style="visibility:hidden;"></input>
	...
	if (document.cookie.length > 0){
		...
		if (i != -1){
			//alert("Estamos aqui dentro de las cookies");</script>
				...
				<%ArrayList error1=((ArrayList)session.getAttribute("resultados_borrar"));
				...
				if(errorPD!=null){
					...
					if (error1!=null ){
							%>
							La Programacion Docente seleccionada se ha borrado Exitosamente!!
							<%
						
					}
				}
				session.removeAttribute("resultados_borrar");
